...
## Corpus Check
- 68 files · ~53,092 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 627 nodes · 848 edges · 99 communities (38 shown, 61 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e2a73e3f`
...
## Communities (99 total, 61 thin omitted)
...
Cohesion: 0.12
Nodes (19): cleanHeading(), slugify(), buildPageStats(), MutableScope, PageStats, Parsed, parsePage(), ScopeStats (+11 more)
...
## Knowledge Gaps
- **250 isolated node(s):** `__dirname`, `unocssConfigPath`, `envFile`, `feedbackWebhooks`, `excluded` (+245 more)
