...
Cohesion: 0.18
Nodes (11): @iconify-json/twemoji, @iconify/utils, @mdit/plugin-abbr, @mdit/plugin-icon, @mdit/plugin-spoiler, devDependencies, @iconify-json/twemoji, @iconify/utils (+3 more)
