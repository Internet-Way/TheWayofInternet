...
export const sidebar: DefaultTheme.Sidebar | DefaultTheme.NavItemWithLink[] = [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: "Privacy/Adblocking", link: "/index/privacy" },
      { text: "AI", link: "/index/ai" },
      { text: "Video Media", link: "/index/video" },
      { text: "Audio Media", link: "/index/audio" },
      { text: "Gaming", link: "/index/gaming" },
      { text: "Reading", link: "/index/reading" },
      { text: "Torrenting", link: "/index/torrenting" },
      { text: "Downloading", link: "/index/ddl" },
    ],
  },
  {
    text: "Tools",
